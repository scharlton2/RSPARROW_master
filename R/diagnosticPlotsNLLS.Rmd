...
path_corrChild<-params$path_corrChild
  ...
  path_diagMapChild<-params$path_diagMapChild
...
rmd <- sapply(
  ...
  function(i) {
   ...
   knit_expand(path_corrChild, i = i)
  }
)
rmd <- paste(rmd, collapse = "\n")
}
...
#################
  ...
  #                c("threshold-above"),"Model Estimation Log Residuals",mapping.input.list, sitedata)
  
   #diagnosticMaps("Resids",mapdata,GeoLines,
  #                 c("threshold-under"),"Model Estimation Log Residuals",mapping.input.list, sitedata)
  # diagnosticMaps("Resids",mapdata,GeoLines,
  #                 c("all"),"Model Estimation Log Residuals",mapping.input.list, sitedata)
...
rmd <- sapply(
  ...
  function(n) {
   ...
   knit_expand(path_diagMapChild, n = n)
  }
)
rmd <- paste(rmd, collapse = "\n")
}
...
#################
  ...
  if(existGeoLines==TRUE) { 
    ...
    #               c("threshold","all"),"Model Simulation Log Residuals",mapping.input.list, sitedata)
    mapTypes<-c("threshold-above","threshold-below","all")
mapColumn<-"pResids"
mapdata<-pmapdata
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE}    
  if(existGeoLines==TRUE) { 
    ...
    #               c("threshold","all"),"Model Estimation Standardized Residuals",mapping.input.list, sitedata)
mapTypes<-c("threshold-above","threshold-below","all")
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE}    
  if(existGeoLines==TRUE) {     
    ...
    #               c("threshold","all"),"Model Estimation Obs/Pred Ratio",mapping.input.list, sitedata)
    mapTypes<-c("threshold-above","threshold-below","all")
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE}    
  ...
  #                 c("threshold","all"),"Model Simulation Obs/Pred Ratio",mapping.input.list, sitedata)
mapTypes<-c("threshold-above","threshold-below","all")
